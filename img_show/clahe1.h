...
#ifdef BYTE_IMAGE
typedef unsigned short kz_pixel_t;	 // for 8 bit-per-pixel images
#define uiNR_OF_GREY (256)
#else
typedef unsigned char kz_pixel_t;	 // for 12 bit-per-pixel images (default)
# define uiNR_OF_GREY (4096)
#endif

/******** Prototype of CLAHE function. Put this in a separate include file. *****/
int CLAHE2(kz_pixel_t* pImage, kz_pixel_t* pImage1, kz_pixel_t* pImage2, unsigned int uiXRes, unsigned int uiYRes, kz_pixel_t Min,
